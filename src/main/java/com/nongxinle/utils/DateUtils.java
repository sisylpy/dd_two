...
public class DateUtils {
    ...
    public final static String TEST_PRINT_PATTERN = "yyyy-MM-dd HH:mm:ss.SSS";
    ...
    public static String testPrintTime() {
        return format(new Date(), TEST_PRINT_PATTERN);
    }
...
//        return format1;
    ...
    public static long getWhatDayTimeStone(String date) {
        Date date1 = new Date();
